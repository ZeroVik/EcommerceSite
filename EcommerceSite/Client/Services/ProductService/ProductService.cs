namespace EcommerceSite.Client.Services.ProductService
{
    public class ProductService : IProductService
    {
        ...
        public string Message { get; set; } = "Зареждане на продуктите";
        ...
        public async Task GetProduct(string? categoryUrl = null)
        {
            ...
            if(Products.Count == 0)
            {
                Message = "Няма намерени продукти";
            }
        ...
        public async Task<List<string>> GetSearchSuggestion(string searchText)
        {
        ...
        public async Task SearchProducts(string searchText, int page)
        {
            ...
            if (Products.Count == 0) Message = "Не са намерени продукти.";
            ProductsChanged?.Invoke();
        }
