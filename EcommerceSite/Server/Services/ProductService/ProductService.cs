namespace EcommerceSite.Server.Services.ProductService
{
    public class ProductService : IProductService
    {
        ...
        public async Task<ServiceResponse<List<Product>>> GetAdminProducts()
        {
            ...
            {
                Data = await _context.Products.Where(p => !p.Deleted).Include(p => p.Variants.Where(v => !v.Deleted)).ThenInclude(v => v.ProductType).ToListAsync()
            };
            return response;
        }
        ...
        public async Task<ServiceResponse<Product>> GetProductAsync(int productId)
        {
            ...
            if(product == null)
            {
                ...
                response.Message = "Продукта не съществува.";
            }
            else
            {
